...
class TestCreateThreeFramings:
    ...
    def test_returns_three_images(self, mock_crop_face, mock_save, full_body_image_bytes):
    ...
    @patch("workflows.video_vto.clothes.generate_video_util.save_debug_image")
    @patch("workflows.video_vto.clothes.generate_video_util.crop_face")
    def test_lower_body_is_bottom_60_percent(self, mock_crop_face, mock_save, full_body_image_bytes):
    ...
    @patch("workflows.video_vto.clothes.generate_video_util.save_debug_image")
    @patch("workflows.video_vto.clothes.generate_video_util.crop_face")
    def test_upper_body_is_top_40_percent(self, mock_crop_face, mock_save, full_body_image_bytes):
    ...
    @patch("workflows.video_vto.clothes.generate_video_util.save_debug_image")
    @patch("workflows.video_vto.clothes.generate_video_util.crop_face")
    def test_face_fallback_when_no_face_detected(self, mock_crop_face, mock_save, full_body_image_bytes):
...
class TestRunR2vPipeline:
    ...
    @patch("workflows.video_vto.clothes.generate_video_util.save_debug_image")
    @patch("workflows.video_vto.clothes.generate_video_util.create_canvas", side_effect=lambda b, **kw: b)
    @patch("workflows.video_vto.clothes.generate_video_util.crop_face", return_value=None)
    @patch("workflows.video_vto.clothes.generate_video_util.generate_veo_r2v")
    def test_returns_expected_keys(self, mock_veo, mock_crop, mock_canvas, mock_save, full_body_image_bytes):
    ...
    @patch("workflows.video_vto.clothes.generate_video_util.crop_face", return_value=None)
    @patch("workflows.video_vto.clothes.generate_video_util.generate_veo_r2v")
    def test_abort_when_first_clip_check_fails(self, mock_veo, mock_crop, mock_canvas, mock_save, full_body_image_bytes):
