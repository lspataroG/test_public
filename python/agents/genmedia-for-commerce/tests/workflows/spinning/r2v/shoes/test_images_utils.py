...
def create_frame_bytes_with_product(width, height, product_rect, bg_color=(255, 255, 255), product_color=(0, 0, 0)):
...
class TestProcessFramesToTargetSize:
    ...
    def test_handles_tuple_target_size(self):
        ...
        frames = [create_frame_bytes_with_product(
    ...
    def test_multiple_frames_same_size(self):
        ...
        for i in range(5):
            frame_bytes = create_frame_bytes_with_product(
                200, 200,
                product_rect=(40 + i*5, 40 + i*5, 100, 100),  # Slightly different positions
                bg_color=(255, 255, 255),
                product_color=(0, 0, 0)
            )
            frames.append(frame_bytes)
