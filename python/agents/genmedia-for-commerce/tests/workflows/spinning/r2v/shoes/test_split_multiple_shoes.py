...
class TestSortMasksByHorizontalPosition:
    ...
    def test_right_mode_sorts_rightmost_first(self):
        ...
        left_mask = [[True, True, False, False, False],
                     [True, True, False, False, False]]
        # Right mask - True pixels on right side
        right_mask = [[False, False, False, True, True],
    ...
    def test_invalid_mode_defaults_to_right(self):
        ...
        mask_data = [(mask, 0.5)]
        result = sort_masks_by_horizontal_position(mask_data, mode='invalid', verbose=True)
        assert len(result) == 1
