...
class TestIsValidPathLessStrict:
    ...
    def test_tolerates_misclassifications(self):
        ...
        path = ["a", "a", "x", "a", "b"]
        is_valid, msg, corrected = is_valid_path_lessstrict(path, allowed, max_consecutive_violations=2)
        assert is_valid is True
    ...
    def test_fails_on_too_many_violations(self):
        ...
        is_valid, msg, corrected = is_valid_path_lessstrict(path, allowed, max_consecutive_violations=5)
        assert is_valid is False
...
class TestFindSecondOccurrenceRange:
    ...
    def test_finds_second_occurrence(self):
        ...
        start, end = find_second_occurrence_range(classes, indices, min_frame_distance=50)
...
class TestSampleFrames:
    ...
    def test_basic_sampling(self):
        ...
        sampled, indices = sample_frames(frames, target_samples_per_sec=12, original_fps=24)
...
class TestAllClassesPresent:
    ...
    def test_all_present(self):
        ...
        classes = ["right", "front_right", "front", "front_left",
    ...
    def test_duplicates_ok(self):
        ...
        classes = ["right", "right", "front_right", "front", "front_left",
                   "left", "back_left", "back", "back_right"]
