...
class TestMatchFramesToReferences:
    ...
    def test_matches_labels(self):
        ...
        result = match_frames_to_references(frame_labels, frame_indices, reference_labels)
...
class TestFindBestMatchesWithSsim:
    ...
    def test_finds_best_match(self, red_image_bytes, blue_image_bytes, similar_red_image_bytes):
