...
from workflows.spinning.r2v.shoes.classify_shoes import (
    ...
    VALIDATION_SHOE_CLASSIFICATION_SYSTEM_PROMPT,
)
...
class TestClassifyShoe:
    ...
    def test_classifies_front_position(self, mock_generate, sample_shoe_image, mock_gemini_client):
    ...
    @patch('workflows.spinning.r2v.shoes.classify_shoes.generate_gemini')
    def test_classifies_left_position(self, mock_generate, sample_shoe_image, mock_gemini_client):
    ...
    @patch('workflows.spinning.r2v.shoes.classify_shoes.generate_gemini')
    def test_classifies_right_position(self, mock_generate, sample_shoe_image, mock_gemini_client):
    ...
    @patch('workflows.spinning.r2v.shoes.classify_shoes.generate_gemini')
    def test_classifies_back_position(self, mock_generate, sample_shoe_image, mock_gemini_client):
    ...
    @patch('workflows.spinning.r2v.shoes.classify_shoes.generate_gemini')
    def test_classifies_multiple(self, mock_generate, sample_shoe_image, mock_gemini_client):
    ...
    @patch('workflows.spinning.r2v.shoes.classify_shoes.generate_gemini')
    def test_classifies_invalid(self, mock_generate, sample_shoe_image, mock_gemini_client):
    ...
    @patch('workflows.spinning.r2v.shoes.classify_shoes.generate_gemini')
    def test_uses_normal_mode_by_default(self, mock_generate, sample_shoe_image, mock_gemini_client):
    ...
    @patch('workflows.spinning.r2v.shoes.classify_shoes.generate_gemini')
    def test_uses_validation_mode(self, mock_generate, sample_shoe_image, mock_gemini_client):
    ...
    @patch('workflows.spinning.r2v.shoes.classify_shoes.generate_gemini')
    def test_uses_temperature_zero(self, mock_generate, sample_shoe_image, mock_gemini_client):
    ...
    @patch('workflows.spinning.r2v.shoes.classify_shoes.generate_gemini')
    def test_passes_image_to_gemini(self, mock_generate, sample_shoe_image, mock_gemini_client):
    ...
    @patch('workflows.spinning.r2v.shoes.classify_shoes.generate_gemini')
    def test_passes_correct_model(self, mock_generate, sample_shoe_image, mock_gemini_client):
...
class TestClassifyShoePositions:
    ...
    @patch('workflows.spinning.r2v.shoes.classify_shoes.generate_gemini')
    def test_all_valid_positions(self, mock_generate, position, sample_shoe_image, mock_gemini_client):
...
class TestClassifyShoeClosure:
    ...
    def test_detects_velcro(self, mock_generate, sample_shoe_image, mock_gemini_client):
        ...
        mock_generate.return_value = json.dumps({
            "has_velcro": True,
            "explanation": "Visible velcro straps on the shoe."
        })
    ...
    @patch('workflows.spinning.r2v.shoes.classify_shoes.generate_gemini')
    def test_handles_multiple_images(self, mock_generate, sample_shoe_image, mock_gemini_client):
        """Should handle multiple input images."""
        mock_generate.return_value = json.dumps({
            "has_velcro": True,
            "explanation": "Velcro visible in multiple angles."
        })
    ...
    @patch('workflows.spinning.r2v.shoes.classify_shoes.generate_gemini')
    def test_uses_default_model(self, mock_generate, sample_shoe_image, mock_gemini_client):
        """Should use default flash-lite model."""
        mock_generate.return_value = json.dumps({
            "has_velcro": False,
            "explanation": "No velcro."
        })
    ...
    @patch('workflows.spinning.r2v.shoes.classify_shoes.generate_gemini')
    def test_uses_custom_model(self, mock_generate, sample_shoe_image, mock_gemini_client):
    ...
    @patch('workflows.spinning.r2v.shoes.classify_shoes.generate_gemini')
    def test_returns_json_response(self, mock_generate, sample_shoe_image, mock_gemini_client):
        """Should return parsed JSON response."""
        mock_generate.return_value = json.dumps({
            "has_velcro": True,
            "explanation": "Found velcro."
        })
    ...
    @patch('workflows.spinning.r2v.shoes.classify_shoes.generate_gemini')
    def test_uses_json_response_format(self, mock_generate, sample_shoe_image, mock_gemini_client):
