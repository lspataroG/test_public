...
class TestCompareFaces:
    ...
    @patch('workflows.shared.person_eval.get_face_embedding_insightface')
    def test_compares_different_faces(self, mock_get_embedding, face_image_bytes, different_face_bytes):
...
class TestEvaluatePersonMatch:
    ...
    def test_evaluates_matching_person(self, mock_compare, mock_crop, face_image_bytes, full_body_image_bytes):
    ...
    @patch('workflows.shared.person_eval.crop_face')
    def test_handles_no_face_detected(self, mock_crop, face_image_bytes, full_body_image_bytes):
    ...
    @patch('workflows.shared.person_eval.crop_face')
    @patch('workflows.shared.person_eval.compare_faces_insightface')
    def test_uses_correct_model(self, mock_compare, mock_crop, face_image_bytes, full_body_image_bytes):
        """Should use InsightFace-ArcFace model."""
    ...
    @patch('workflows.shared.person_eval.crop_face')
    @patch('workflows.shared.person_eval.compare_faces_insightface')
    def test_handles_comparison_error(self, mock_compare, mock_crop, face_image_bytes, full_body_image_bytes):
    ...
    @patch('workflows.shared.person_eval.crop_face')
    @patch('workflows.shared.person_eval.compare_faces_insightface')
    def test_returns_correct_result_structure(self, mock_compare, mock_crop, face_image_bytes, full_body_image_bytes):
...
class TestSubmitEvaluation:
    ...
    def test_submits_to_pool(self, mock_get_pool, face_image_bytes, full_body_image_bytes):
    ...
    @patch('workflows.shared.person_eval.get_eval_pool')
    def test_passes_model_name(self, mock_get_pool, face_image_bytes, full_body_image_bytes):
        """Should pass arguments to evaluation function."""
        mock_pool = Mock()
        mock_get_pool.return_value = mock_pool

        from workflows.shared.person_eval import submit_evaluation, evaluate_person_match
...
class TestGetEvalPool:
    ...
    def test_pool_max_workers(self, mock_executor_class):
        ...
        from workflows.shared.person_eval import get_eval_pool, _POOL_MAX_WORKERS
