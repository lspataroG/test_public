...
class TestUploadFolderToGcs:
    ...
    @patch('workflows.shared.gcs_utils.get_storage_client')
    def test_uploads_all_files(self, mock_get_client, mock_upload_many, mock_storage_client, temp_folder_with_files):
        """Should upload all files in folder."""
        client, bucket, blob = mock_storage_client
        mock_get_client.return_value = client
        mock_upload_many.return_value = [None, None, None, None]  # Success for each file
    ...
    @patch('workflows.shared.gcs_utils.transfer_manager.upload_many')
    @patch('workflows.shared.gcs_utils.get_storage_client')
    def test_filters_by_extension(self, mock_get_client, mock_upload_many, mock_storage_client, temp_folder_with_files):
    ...
    @patch('workflows.shared.gcs_utils.transfer_manager.upload_many')
    @patch('workflows.shared.gcs_utils.get_storage_client')
    def test_excludes_extensions(self, mock_get_client, mock_upload_many, mock_storage_client, temp_folder_with_files):
    ...
    @patch('workflows.shared.gcs_utils.transfer_manager.upload_many')
    @patch('workflows.shared.gcs_utils.get_storage_client')
    def test_handles_destination_prefix(self, mock_get_client, mock_upload_many, temp_folder_with_files):
    ...
    @patch('workflows.shared.gcs_utils.transfer_manager.upload_many')
    @patch('workflows.shared.gcs_utils.get_storage_client')
    def test_returns_empty_for_empty_folder(self, mock_get_client, mock_upload_many, mock_storage_client):
    ...
    @patch('workflows.shared.gcs_utils.transfer_manager.upload_many')
    @patch('workflows.shared.gcs_utils.get_storage_client')
    def test_raises_on_upload_error(self, mock_get_client, mock_upload_many, mock_storage_client, temp_folder_with_files):
    ...
    @patch('workflows.shared.gcs_utils.transfer_manager.upload_many')
    @patch('workflows.shared.gcs_utils.get_storage_client')
    def test_respects_max_workers(self, mock_get_client, mock_upload_many, mock_storage_client, temp_folder_with_files):
