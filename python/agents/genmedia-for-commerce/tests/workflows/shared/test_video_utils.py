...
class TestFindMostSimilarFrameIndex:
    ...
    def test_finds_identical_frame(self, red_image_bytes, blue_image_bytes, green_image_bytes):
    ...
    def test_num_frames_to_check(self, red_image_bytes, blue_image_bytes, green_image_bytes):
        """Should only check the last N frames when num_frames_to_check is set."""
        # red at index 0, blue at 1, 2, 3, green at 4
        frames = [red_image_bytes, blue_image_bytes, blue_image_bytes, blue_image_bytes, green_image_bytes]
        reference = red_image_bytes
...
class TestCreateMp4FromBytesToBytes:
    ...
    def test_creates_video_from_frames(self, red_image_bytes, blue_image_bytes, green_image_bytes):
...
class TestExtractFramesAsBytesList:
    ...
    def test_extracts_frames_from_video(self, red_image_bytes, blue_image_bytes, green_image_bytes):
...
class TestReverseVideo:
    ...
    def test_reverses_frame_order(self, red_image_bytes, blue_image_bytes, green_image_bytes):
...
class TestMergeVideosFromBytes:
    ...
    def test_merges_two_videos(self, red_image_bytes, blue_image_bytes, green_image_bytes):
    ...
    def test_merges_three_videos(self, red_image_bytes, blue_image_bytes, green_image_bytes):
        """Should merge three videos into one."""
        video1 = create_mp4_from_bytes_to_bytes([red_image_bytes] * 3, fps=24, quality=7)
        video2 = create_mp4_from_bytes_to_bytes([blue_image_bytes] * 3, fps=24, quality=7)
        video3 = create_mp4_from_bytes_to_bytes([green_image_bytes] * 3, fps=24, quality=7)
    ...
    def test_merge_with_speed_adjustment(self, red_image_bytes, blue_image_bytes):
        ...
        video1 = create_mp4_from_bytes_to_bytes([red_image_bytes] * 10, fps=24, quality=7)
        video2 = create_mp4_from_bytes_to_bytes([blue_image_bytes] * 10, fps=24, quality=7)
    ...
    def test_merge_preserves_content(self, red_image_bytes, blue_image_bytes):
        ...
        video1 = create_mp4_from_bytes_to_bytes([red_image_bytes] * 5, fps=24, quality=7)
        video2 = create_mp4_from_bytes_to_bytes([blue_image_bytes] * 5, fps=24, quality=7)
