...
from workflows.shared.veo_utils import generate_veo, generate_veo_r2v, VeoEmptyResultError
...
class TestGenerateVeo:
    ...
    def test_generates_video_from_image(self, mock_sleep, mock_veo_client, sample_image_bytes, sample_video_bytes):
    ...
    @patch('workflows.shared.veo_utils.time.sleep')
    def test_generates_video_with_last_frame(self, mock_sleep, mock_veo_client, sample_image_bytes, sample_video_bytes):
    ...
    @patch('workflows.shared.veo_utils.time.sleep')
    def test_respects_duration_parameter(self, mock_sleep, mock_veo_client, sample_image_bytes):
    ...
    @patch('workflows.shared.veo_utils.time.sleep')
    def test_respects_aspect_ratio(self, mock_sleep, mock_veo_client, sample_image_bytes):
    ...
    @patch('workflows.shared.veo_utils.time.sleep')
    def test_handles_multiple_videos(self, mock_sleep, sample_image_bytes, sample_video_bytes):
    ...
    @patch('workflows.shared.veo_utils.time.sleep')
    def test_waits_for_operation_completion(self, mock_sleep, mock_veo_client_pending, sample_image_bytes):
    ...
    @patch('workflows.shared.veo_utils.time.sleep')
    def test_raises_on_empty_result(self, mock_sleep, mock_veo_client_empty, sample_image_bytes):
    ...
    @patch('workflows.shared.veo_utils.time.sleep')
    def test_person_generation_parameter(self, mock_sleep, mock_veo_client, sample_image_bytes):
    ...
    @patch('workflows.shared.veo_utils.time.sleep')
    def test_enhance_prompt_parameter(self, mock_sleep, mock_veo_client, sample_image_bytes):
    ...
    @patch('workflows.shared.veo_utils.time.sleep')
    def test_generate_audio_parameter(self, mock_sleep, mock_veo_client, sample_image_bytes):
...
class TestGenerateVeoR2V:
    ...
    @patch('workflows.shared.veo_utils.time.sleep')
    def test_generates_video_from_references(self, mock_sleep, mock_veo_client, sample_image_bytes, sample_video_bytes):
    ...
    @patch('workflows.shared.veo_utils.time.sleep')
    def test_uses_asset_reference_type(self, mock_sleep, mock_veo_client, sample_image_bytes):
    ...
    @patch('workflows.shared.veo_utils.time.sleep')
    def test_supports_style_reference_type(self, mock_sleep, mock_veo_client, sample_image_bytes):
    ...
    @patch('workflows.shared.veo_utils.time.sleep')
    def test_handles_single_reference(self, mock_sleep, mock_veo_client, sample_image_bytes, sample_video_bytes):
    ...
    @patch('workflows.shared.veo_utils.time.sleep')
    def test_handles_multiple_references(self, mock_sleep, mock_veo_client, sample_image_bytes, sample_video_bytes):
    ...
    def test_raises_on_empty_result(self, mock_sleep, mock_veo_client_empty, sample_image_bytes):
        ...
        with patch.object(generate_veo_r2v, '__wrapped__', generate_veo_r2v.__wrapped__):
            with pytest.raises(VeoEmptyResultError, match="empty result"):
    ...
    @patch('workflows.shared.veo_utils.time.sleep')
    def test_waits_for_completion(self, mock_sleep, mock_veo_client_pending, sample_image_bytes, sample_video_bytes):
    ...
    @patch('workflows.shared.veo_utils.time.sleep')
    def test_generate_audio_disabled_by_default(self, mock_sleep, mock_veo_client, sample_image_bytes):
