...
class TestCreateCanvas:
    ...
    def test_zoom_factor(self, sample_image_bytes):
        ...
        result_normal = create_canvas(sample_image_bytes, canvas_width=500, canvas_height=500)
...
class TestStackImagesHorizontally:
    ...
    def test_different_heights(self, sample_image_bytes_200x100, sample_image_bytes_100x200):
...
class TestStackAndCanvasImages:
    ...
    def test_four_images_stacks_last_two(self, sample_image_bytes):
        ...
        result = stack_and_canvas_images(
            [sample_image_bytes, sample_image_bytes, sample_image_bytes, sample_image_bytes]
        )
...
class TestUpscaleImageBytes:
    ...
    def mock_imagen_client(self):
        ...
        client.models.upscale_image.side_effect = lambda **kwargs: create_upscale_response(
    ...
    @patch('workflows.shared.image_utils.save_debug_image')
    def test_uses_x4_by_default(self, mock_save, mock_imagen_client, sample_image_bytes):
    ...
    @patch('workflows.shared.image_utils.save_debug_image')
    def test_respects_upscale_factor(self, mock_save, mock_imagen_client, sample_image_bytes):
    ...
    def test_rejects_invalid_factor(self, mock_imagen_client, sample_image_bytes):
        ...
        with pytest.raises(ValueError, match="must be 'x2', 'x3', or 'x4'"):
            upscale_image_bytes(mock_imagen_client, sample_image_bytes, upscale_factor='x5')
...
class TestReplaceBackground:
    ...
    @patch('workflows.shared.image_utils.save_debug_image')
    def test_replaces_background_white(self, mock_save, mock_segmentation_client, sample_image_bytes):
    ...
    @patch('workflows.shared.image_utils.save_debug_image')
    def test_custom_background_color(self, mock_save, mock_segmentation_client, sample_image_bytes):
        """Should use custom background color."""
        result = replace_background(
            mock_segmentation_client,
            sample_image_bytes,
    ...
    @patch('workflows.shared.image_utils.save_debug_image')
    def test_transparent_background(self, mock_save, mock_segmentation_client, sample_image_bytes):
    ...
    @patch('workflows.shared.image_utils.save_debug_image')
    def test_mask_margin_pixels(self, mock_save, mock_segmentation_client, sample_image_bytes):
        """Should apply mask margin when specified."""
        result = replace_background(
            mock_segmentation_client,
            sample_image_bytes,
            mask_margin_pixels=10
        )
    ...
    @patch('workflows.shared.image_utils.save_debug_image')
    def test_falls_back_to_rembg(self, mock_save, mock_vertex, mock_rembg, sample_image_bytes):
...
class TestCropFace:
    ...
    @patch('workflows.shared.image_utils.save_debug_image')
    def test_crops_detected_face(self, mock_save, mock_client_class, mock_vision_response_with_face, sample_image_bytes):
    ...
    @patch('workflows.shared.image_utils.vision.ImageAnnotatorClient')
    @patch('workflows.shared.image_utils.save_debug_image')
    def test_returns_none_when_no_face(self, mock_save, mock_client_class, mock_vision_response_no_face, sample_image_bytes):
    ...
    @patch('workflows.shared.image_utils.vision.ImageAnnotatorClient')
    @patch('workflows.shared.image_utils.save_debug_image')
    def test_respects_padding_ratio(self, mock_save, mock_client_class, mock_vision_response_with_face, sample_image_bytes):
    ...
    @patch('workflows.shared.image_utils.vision.ImageAnnotatorClient')
    @patch('workflows.shared.image_utils.save_debug_image')
    def test_saves_debug_images(self, mock_save, mock_client_class, mock_vision_response_with_face, sample_image_bytes):
...
class TestExtractUpscaleProduct:
    ...
    def test_extracts_and_upscales(self, mock_replace_mask, mock_upscale, mock_apply_mask, sample_image_bytes):
    ...
    @patch('workflows.shared.image_utils.upscale_image_bytes')
    @patch('workflows.shared.image_utils.replace_background_with_mask_return')
    def test_cleans_after_upscale(self, mock_replace_mask, mock_upscale, mock_apply_mask, sample_image_bytes):
    ...
    def test_skips_clean_when_disabled(self, mock_replace, mock_upscale, sample_image_bytes):
    ...
    @patch('workflows.shared.image_utils.upscale_image_bytes')
    @patch('workflows.shared.image_utils.replace_background_with_mask_return')
    def test_applies_mask_after_upscale(self, mock_replace_mask, mock_upscale, mock_apply_mask, sample_image_bytes):
...
class TestGetBackgroundMaskVertex:
    ...
    def test_preserves_small_images(self, mock_vertex_client, sample_image_bytes):
        ...
        get_background_mask_vertex(mock_vertex_client, sample_image_bytes, max_dimension=2048)
