...
class TestGetGenerateContentConfig:
    ...
    def test_system_instruction_string(self):
        ...
        config = get_generate_content_config(system_instruction="You are a helpful assistant.")
...
class TestRetryWithExponentialBackoff:
    ...
    def test_handles_multiple_exception_types(self, mock_sleep):
        ...
        @retry_with_exponential_backoff(max_retries=4, exceptions=(ValueError, TypeError))
