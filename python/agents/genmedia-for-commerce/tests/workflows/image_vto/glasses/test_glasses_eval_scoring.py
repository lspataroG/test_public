...
class TestEvaluateGlassesWeightedScore:
    ...
    def test_weighted_average_all_tens(self, mock_generate, mock_client, fake_image_bytes):
    ...
    @patch("workflows.image_vto.glasses.glasses_eval.generate_gemini")
    def test_weighted_average_all_zeros(self, mock_generate, mock_client, fake_image_bytes):
    ...
    @patch("workflows.image_vto.glasses.glasses_eval.generate_gemini")
    def test_weighted_average_mixed_scores(self, mock_generate, mock_client, fake_image_bytes):
...
class TestEvaluateGlassesClamping:
    ...
    @patch("workflows.image_vto.glasses.glasses_eval.generate_gemini")
    def test_clamps_scores_above_ten(self, mock_generate, mock_client, fake_image_bytes):
    ...
    @patch("workflows.image_vto.glasses.glasses_eval.generate_gemini")
    def test_clamps_negative_scores_to_zero(self, mock_generate, mock_client, fake_image_bytes):
...
class TestEvaluateGlassesErrorHandling:
    ...
    @patch("workflows.image_vto.glasses.glasses_eval.generate_gemini")
    def test_returns_zeros_on_api_exception(self, mock_generate, mock_client, fake_image_bytes):
    ...
    @patch("workflows.image_vto.glasses.glasses_eval.generate_gemini")
    def test_returns_zeros_on_missing_key(self, mock_generate, mock_client, fake_image_bytes):
...
class TestEvaluateAllGlassesDiscard:
    ...
    def test_discard_when_any_attribute_is_zero(self, mock_eval, mock_client, fake_image_bytes):
    ...
    @patch("workflows.image_vto.glasses.glasses_eval.evaluate_glasses")
    def test_no_discard_when_all_attributes_nonzero(self, mock_eval, mock_client, fake_image_bytes):
    ...
    @patch("workflows.image_vto.glasses.glasses_eval.evaluate_glasses")
    def test_uses_first_glasses_image_as_reference(self, mock_eval, mock_client, fake_image_bytes):
        ...
        evaluate_all_glasses(mock_client, fake_image_bytes, [fake_image_bytes, second_image])
