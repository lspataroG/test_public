...
tuned_model_display_name = f"classifier_{adapter_size}_lr_{LR_MULTIPLIER}_epochs_{NUMBER_OF_EPOCHS}_v{VERSION}"
...
def main():
    ...
    job_name = tuning_job.name  # e.g. projects/123/locations/europe-west4/tuningJobs/456
