...
def apply_scaled_mask_after_upscale(upscaled_bytes, original_mask, background_color="#FFFFFF"):
    """
...
def extract_upscale_product(
    ...
    try:
        if clean_after_upscale:
            ...
            extracted_bytes, mask = replace_background_with_mask_return(client, img_bytes)
            # Upscale
