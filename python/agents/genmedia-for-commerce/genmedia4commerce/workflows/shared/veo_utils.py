...
@retry_with_exponential_backoff(max_retries=5, exceptions=(ClientError, VeoEmptyResultError))
def generate_veo(
    client,
    image,
    prompt,
    ...
    if last_frame is not None:
        config_kwargs["last_frame"] = Image(imageBytes=last_frame, mime_type="image/png")
