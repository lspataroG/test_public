...
from mcp_server.product_enrichment.product_fitting.product_fitting_api import router as product_fitting_router
...
from mcp_server.other.background_changer.background_changer_api import router as background_changer_router
...
from mcp_server.spinning.interpolation.other.other_api import router as interpolation_other_router
...
def _mount_frontend():
    ...
    static_mounts = {
        ...
        "/glasses/images/models": backend_dir / "image_vto" / "glasses" / "images" / "models",
        "/glasses/images": backend_dir / "image_vto" / "glasses" / "images",
        "/shoes/spinning/images": backend_dir / "spinning" / "r2v" / "shoes" / "images",
        "/other/images/products_r2v": backend_dir / "spinning" / "r2v" / "other" / "images",
        "/other/images/products_interpolation": backend_dir / "spinning" / "interpolation" / "other" / "images",
    }
...
async def get_status():
    ...
    def _check_segmentation():
        try:
            ...
            probe_client = genai.Client(vertexai=True, project=project_id, location=location)
