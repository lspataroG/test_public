            ...
            if os.path.isdir(folder_path) and folder_name.startswith("product_"):
                ...
                for filename in sorted(os.listdir(folder_path)):
                    if filename.lower().endswith((".png", ".jpg", ".jpeg")):
                        image_url = f"/other/images/products_r2v/{folder_name}/{filename}"
...
async def r2v_preprocess(images: list[UploadFile] = File(...)):
    ...
    try:
        ...
        return JSONResponse(content={"processed_images": results, "num_processed": len(results)})
    except Exception as e:
...
async def r2v_generate_prompt(images: list[UploadFile] = File(...)):
    ...
    try:
        ...
        return JSONResponse(content={"prompt": prompt_text, "description": product_description})
    except Exception as e:
