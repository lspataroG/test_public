...
async def get_templates():
    ...
    if os.path.exists(men_templates_path):
        with open(men_templates_path, "r") as f:
            for line in f:
                men_videos.append(json.loads(line))

    women_videos = []
    if os.path.exists(women_templates_path):
        with open(women_templates_path, "r") as f:
            for line in f:
    ...
    try:
        ...
        if custom_field_dict:
            try:
                ...
                logger.warning(f"Failed to parse custom_field_dict: {custom_field_dict}")
